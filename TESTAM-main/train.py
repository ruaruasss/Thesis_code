...
parser.add_argument('--data',type=str,default='/home/p_tf_zy/p_tf_01/TESTAM-main/data/PEMS-BAY',help='data path')
parser.add_argument('--adjdata',type=str,default='/home/p_tf_zy/p_tf_01/TESTAM-main/data/PEMS-BAY/adj_mx_bay.pkl',help='adj data path')
...
parser.add_argument('--save',type=str,default='/home/p_tf_zy/p_tf_01/TESTAM-main/experiment/PEMS-BAY_TESTAM',help='save path')
