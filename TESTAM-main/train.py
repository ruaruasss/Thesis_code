...
parser.add_argument('--data',type=str,default='/home/p_tf_zy/p_tf_01/TESTAM-main/data/METR-LA',help='data path')
parser.add_argument('--adjdata',type=str,default='/home/p_tf_zy/p_tf_01/TESTAM-main/data/METR-LA/adj_mx.pkl',help='adj data path')
...
parser.add_argument('--save',type=str,default='/home/p_tf_zy/p_tf_01/TESTAM-main/experiment/METR-LA_TESTAM',help='save path')
